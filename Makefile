...
setup:
	...
	unzip bundled/duckdb-static-lib-windows-mingw.zip
	unzip bundled/static-lib-windows-mingw.zip
	cp bundled/libduckdb_bundle.a deps/windows_amd64/libduckdb.a
